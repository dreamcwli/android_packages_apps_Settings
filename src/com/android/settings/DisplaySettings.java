...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    private String mChargingLightFilename;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mChargingLightFilename = resources.getString(
                com.android.internal.R.string.config_chargingLightFilename);
        ...
        if (resources.getBoolean(com.android.internal.R.bool.config_chargingLightSupported)
                && Utils.isFileExisted(mChargingLightFilename)) {
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mAccelerometer) {
            ...
            Utils.writeOneLineFile(mChargingLightFilename, value
    ...
    public static class BootReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            final String chargingLightFilename = resources.getString(
                    com.android.internal.R.string.config_chargingLightFilename);
            if (resources.getBoolean(com.android.internal.R.bool.config_chargingLightSupported)
                    && Utils.isFileExisted(chargingLightFilename)) {
                final String chargingLightEnabledValue = resources.getString(
                        com.android.internal.R.string.config_chargingLightEnabledValue);
                final String chargingLightDisabledValue = resources.getString(
                        com.android.internal.R.string.config_chargingLightDisabledValue);
                Utils.writeOneLineFile(chargingLightFilename,
